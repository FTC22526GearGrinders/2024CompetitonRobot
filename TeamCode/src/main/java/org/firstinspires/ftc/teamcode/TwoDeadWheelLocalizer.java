...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 3.5 * .001978; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 7.25 * .001978; // x position of the perpendicular encoder (in tick units)
    }
